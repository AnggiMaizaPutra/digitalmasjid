                                        ...
                                        <tbody>
                                            ...
                                            foreach ($kaskeluar as $val) {
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-warning btn-sm btn-edit" data-id="<?= $val['id_kas_masjid']; ?>" 
                                                        data-tanggal="<?= $val['tanggal']; ?>" data-ket="<?= $val['ket']; ?>" data-kas_keluar="<?= $val['kas_keluar']; ?>" data-jenis_kas="<?= $val['jenis_kas'];  ?>">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <label> Agenda </label>
                        <button type="button" data-toggle="modal" data-target="#modal_agenda"
                        ...
                        <div class="form-group">   
                            ...
                            <input type="text" name="idagenda" readonly id="idagenda"
                            class="form-control">
                            </div>
                        </div> 
                        <div class="col-md-5">
